...
### Databricks Queries
- [KPI Calculations](queries-e-commerce/Databricks%20SQL%20for%20KPIs.dbquery.ipynb)
- [CLV Proxy](queries-e-commerce/CLV%20proxy.dbquery.ipynb)
- [CAC vs LTV Ratio by Cohort](queries-e-commerce/CAC%20vs%20LTV%20ratio%20by%20cohort.dbquery.ipynb)
- [Run Log Table](notebooks-e-commerce/run%20log%20table.ipynb)
